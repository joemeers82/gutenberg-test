...
registerBlockType( 'udemy/night-mode', {
    ...
    edit: ( props ) => {
        ...
        return [
            <div>
            <InspectorControls>
                <PanelBody title={ __('Night Mode', 'gutenberg-test') }>
                    <PanelRow>
                        <label htmlFor="udemy-receipt-night-mode-toggle">
                            {__( 'Night Mode', 'gutenberg-test' ) }
                        </label>
                        <FormToggle id='udemy-receipt-night-mode-toggle'
            ...
            <div className= { props.className } >
                <BlockControls>
                    <Toolbar>
                        <Tooltip text={ __('Night mode', 'gutenberg-test' ) }>
